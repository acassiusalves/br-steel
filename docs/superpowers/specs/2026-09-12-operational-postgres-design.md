...
O primeiro plano executável está em [preparação da leitura](../plans/2026-09-12-operational-postgres-phase1.md). A etapa 2 foi dividida em [schema, importação e leitura local de vendas](../plans/2026-09-12-operational-postgres-phase2.md) e [consultas de estoque, insumos e produção](../plans/2026-09-12-operational-postgres-readers.md). A etapa 3 foi coberta por [piloto hospedado](../plans/2026-09-12-operational-postgres-hosted-pilot.md), [piloto de endpoints](../plans/2026-09-12-operational-postgres-endpoint-pilot.md) e [backup e restauração](../plans/2026-09-12-operational-postgres-backup.md). As etapas seguintes têm planos escritos: [gravações do núcleo](../plans/2026-09-12-operational-postgres-phase4-writes.md), [troca da fonte](../plans/2026-09-12-operational-postgres-phase5-cutover.md) e [observação e consolidação](../plans/2026-09-12-operational-postgres-phase6-consolidation.md). Esses três planos são roteiros; cada um só pode ser executado depois de os resultados do anterior serem verificados, e as etapas 5 e 6 alteram produção e exigem autorização explícita a cada tarefa.
...
Backup do núcleo diário, criptografado fora do projeto de origem, é a proposta inicial a medir, com objetivo de perda máxima de 24 horas e recuperação em até 2 horas. Esses objetivos precisam ser aceitos para produção e comprovados em um ensaio; o ensaio de 12/09 recuperou a cópia real no schema final em 3,42 segundos localmente; ainda não comprova recuperação no serviço gerenciado, obtenção externa da chave e retomada da aplicação. Se a necessidade operacional exigir recuperação de alterações mais recentes, a estratégia de recuperação e o orçamento deverão ser revistos antes do corte. Retenção inicial proposta: sete cópias diárias e quatro semanais, reaproveitando a cópia diária para evitar download adicional do banco.

O backup do schema final mediu 35,00 MB recebidos via TCP e arquivo criptografado de 4,44 MB. Trinta downloads no volume atual projetam 1,05 GB de tráfego TCP, sem equivalência automática com a cobrança do provedor. Arquivo e chave do ensaio permanecem em pastas privadas separadas deste computador; armazenamento externo, custódia independente, agendamento e alertas ainda precisam ser operacionalizados. [Evidência de recuperação](../../evidence/operational-postgres-backup.md).
