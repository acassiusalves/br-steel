...
import { PlusCircle, Trash2, Loader2, Lock, Users, UserPlus, Clock, KeyRound, Copy, Save, CheckCircle, XCircle, Plug, Sheet, Database, FileDown, Search, Package, Store } from 'lucide-react';
      ...
      <div className="flex-1 space-y-8 p-4 pt-6 md:p-8">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie as configurações de usuários, permissões e conexões do sistema.
          </p>
        </div>

        <Tabs defaultValue={tab} value={tab} className="w-full" onValueChange={(value) => {
