...
import { KeyRound, Loader2, Copy, Save } from 'lucide-react';
...
export default function ApiPage() {
  ...
  const handleSaveCredentials = async () => {
    setIsSaving(true);
    try {
        await saveBlingCredentials(credentials);
        toast({
              ...
              <CardContent>
                <div className="flex flex-col items-start gap-6 max-w-lg">
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <Button onClick={handleConnect} disabled={isLoading || !credentials.clientId}>
                      {isLoading ? (
                        <>
                          <Loader2 className="mr-2 h-4 w-4 animate-spin" />
                          Gerando...
