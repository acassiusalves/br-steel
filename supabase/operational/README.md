...
O [ensaio do corte de 16/09/2026](../../docs/evidence/operational-postgres-cutover-rehearsal.md) executou a sequência inteira contra o destino hospedado — bloqueio, reconciliação de 13.063 registros e comparação com **divergência zero** — com o núcleo de produção parado por 10 min 15 s. Uma primeira tentativa revelou que o `reconcile` não alcançava o hospedado, defeito corrigido antes da segunda. A [prova de reversibilidade de 16/09/2026](../../docs/evidence/operational-postgres-reversibility.md) fechou o último item em aberto: a leitura passou a responder do PostgreSQL com a troca do registro na homologação e voltou ao estado anterior quando ele saiu.
